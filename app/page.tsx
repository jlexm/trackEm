...
export default function ScanQR() {
  ...
  return (
    <div>
      <NavBar />
      <div className="flex flex-col items-center justify-center min-h-screen p-8 gap-8 bg-gray-100 dark:bg-gray-900">
        <h1 className="text-3xl font-bold text-center text-gray-900 dark:text-white">
          Scan a Turtle QR Code
        </h1>

        <div className="w-full max-w-md bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex justify-center items-center">
          <div id="qr-reader" className="w-full" />
        </div>

        {scannedData && (
          <div className="mt-4 text-center">
            <p className="text-gray-700 dark:text-gray-300">Scanned Data:</p>
